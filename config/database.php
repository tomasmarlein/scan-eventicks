...
return [
    ...
    */
    ...
    'redis' => [
        ...
        'options' => ['prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME','laravel'), '_').'_')],
        ...
        'session' => ['host'=>env('REDIS_HOST'),'password'=>env('REDIS_PASSWORD'),'port'=>env('REDIS_PORT'),'database'=>env('REDIS_SESSION_DB',2)],
        'queue'   => ['host'=>env('REDIS_HOST'),'password'=>env('REDIS_PASSWORD'),'port'=>env('REDIS_PORT'),'database'=>env('REDIS_QUEUE_DB',3)],
    ],
